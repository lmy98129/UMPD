...
class MultiviewX(VisionDataset):
    def __init__(self, root):
        ...
        # default img_reduce following DINOv2
        self.img_reduce = 14
        ...
        self.worldgrid_translation = [ int(x * 0.025 * 100 // 2) for x in self.worldgrid_shape[::-1] ]

        self.expand_width, self.expand_length = 50, 50
        # voxel_size 15 for MultiviewX with more smaller pedestrians
        self.bev_height, self.voxel_size, self.sigma = 30, 15, 4
    ...
    def get_intrinsic_extrinsic_matrix(self, camera_i):
        ...
        translation_matrix = -100 * np.array(tvec, dtype=np.float32).reshape(3, 1)
